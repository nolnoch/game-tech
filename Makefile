...
ACLOCAL = ${SHELL} /u/nolnoch/game-tech/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /u/nolnoch/game-tech/missing --run autoconf
AUTOHEADER = ${SHELL} /u/nolnoch/game-tech/missing --run autoheader
AUTOMAKE = ${SHELL} /u/nolnoch/game-tech/missing --run automake-1.11
AWK = gawk
BULLET_CFLAGS = 
BULLET_LIBS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /u/nolnoch/game-tech/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.1
abs_builddir = /u/nolnoch/game-tech
abs_srcdir = /u/nolnoch/game-tech
abs_top_builddir = /u/nolnoch/game-tech
abs_top_srcdir = /u/nolnoch/game-tech
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /u/nolnoch/game-tech/install-sh
...
OgreApp-TileSimulator.o: TileSimulator.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -MT OgreApp-TileSimulator.o -MD -MP -MF $(DEPDIR)/OgreApp-TileSimulator.Tpo -c -o OgreApp-TileSimulator.o `test -f 'TileSimulator.cpp' || echo '$(srcdir)/'`TileSimulator.cpp
	$(am__mv) $(DEPDIR)/OgreApp-TileSimulator.Tpo $(DEPDIR)/OgreApp-TileSimulator.Po
#	source='TileSimulator.cpp' object='OgreApp-TileSimulator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -c -o OgreApp-TileSimulator.o `test -f 'TileSimulator.cpp' || echo '$(srcdir)/'`TileSimulator.cpp

OgreApp-TileSimulator.obj: TileSimulator.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -MT OgreApp-TileSimulator.obj -MD -MP -MF $(DEPDIR)/OgreApp-TileSimulator.Tpo -c -o OgreApp-TileSimulator.obj `if test -f 'TileSimulator.cpp'; then $(CYGPATH_W) 'TileSimulator.cpp'; else $(CYGPATH_W) '$(srcdir)/TileSimulator.cpp'; fi`
	$(am__mv) $(DEPDIR)/OgreApp-TileSimulator.Tpo $(DEPDIR)/OgreApp-TileSimulator.Po
#	source='TileSimulator.cpp' object='OgreApp-TileSimulator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -c -o OgreApp-TileSimulator.obj `if test -f 'TileSimulator.cpp'; then $(CYGPATH_W) 'TileSimulator.cpp'; else $(CYGPATH_W) '$(srcdir)/TileSimulator.cpp'; fi`

OgreApp-BallManager.o: BallManager.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -MT OgreApp-BallManager.o -MD -MP -MF $(DEPDIR)/OgreApp-BallManager.Tpo -c -o OgreApp-BallManager.o `test -f 'BallManager.cpp' || echo '$(srcdir)/'`BallManager.cpp
	$(am__mv) $(DEPDIR)/OgreApp-BallManager.Tpo $(DEPDIR)/OgreApp-BallManager.Po
#	source='BallManager.cpp' object='OgreApp-BallManager.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -c -o OgreApp-BallManager.o `test -f 'BallManager.cpp' || echo '$(srcdir)/'`BallManager.cpp

OgreApp-BallManager.obj: BallManager.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(OgreApp_CPPFLAGS) $(CPPFLAGS) $(OgreApp_CXXFLAGS) $(CXXFLAGS) -MT OgreApp-BallManager.obj -MD -MP -MF $(DEPDIR)/OgreApp-BallManager.Tpo -c -o OgreApp-BallManager.obj `if test -f 'BallManager.cpp'; then $(CYGPATH_W) 'BallManager.cpp'; else $(CYGPATH_W) '$(srcdir)/BallManager.cpp'; fi`
	$(am__mv) $(DEPDIR)/OgreApp-BallManager.Tpo $(DEPDIR)/OgreApp-BallManager.Po
#	source='BallManager.cpp' object='OgreApp-BallManager.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
